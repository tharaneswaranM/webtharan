...
const split = new SplitText(".text_invert", {
    type: "lines"
});
...
if (device_width < 1023) {
    ...
    gsap.set(".product_items_fade_anim", {
        opacity: 0,
        y: 40
    })
...
if (device_width < 1023) {
    ...
    gsap.set(".jurnal_fade_animation", {
        opacity: 0,
        y: 40
    })
...
if (device_width < 1023) {
    ...
    gsap.set(".product_fade_animation", {
        opacity: 0,
        y: 40
    })
...
if (device_width < 1023) {
    ...
    gsap.set(".fade_dev_blog_items_anim", {
        opacity: 0,
        y: 40
    })
